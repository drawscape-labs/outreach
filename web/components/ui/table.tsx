      ...
      <div className="flow-root">
        <div {...props} className={cn(className, '-mx-(--gutter) overflow-x-auto whitespace-nowrap')}>
          <div className={cn('inline-block min-w-full align-middle', !bleed && 'sm:px-(--gutter)')}>
            <table className="min-w-full text-left text-sm/6 text-zinc-950 dark:text-zinc-100">{children}</table>
          </div>
        </div>
      </div>
    ...
    <TableRowContext.Provider value={{ href, target, title } as React.ContextType<typeof TableRowContext>}>
      <tr
        ...
        className={cn(
          ...
          striped && 'even:bg-zinc-950/2.5 dark:even:bg-white/5',
          href && striped && 'hover:bg-zinc-950/5 dark:hover:bg-white/5',
          href && !striped && 'hover:bg-zinc-950/2.5 dark:hover:bg-white/5'
        )}
      />
  ...
  return (
    <th
      ...
      className={cn(
        ...
        grid && 'border-l border-l-zinc-950/5 first:border-l-0 dark:border-l-white/10',
  ...
  return (
    <td
      ...
      className={cn(
        ...
        !striped && 'border-b border-zinc-950/5 dark:border-white/10',
        grid && 'border-l border-l-zinc-950/5 first:border-l-0 dark:border-l-white/10',
        dense ? 'py-2.5' : 'py-4',
        !bleed && 'sm:first:pl-1 sm:last:pr-1'
      )}
