...
export function SidebarDivider({ className, ...props }: React.ComponentPropsWithoutRef<'hr'>) {
  return <hr {...props} className={cn(className, 'my-4 border-t border-zinc-950/5 lg:-mx-4')} />
}
...
export function SidebarHeading({ className, ...props }: React.ComponentPropsWithoutRef<'h3'>) {
  ...
  return (
    <h3 {...headingProps} className={cn(className, 'mb-1 px-2 text-xs/6 font-medium text-zinc-500')}>
      {children}
    </h3>
  )
}
