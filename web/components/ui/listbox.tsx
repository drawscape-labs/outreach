    ...
    <Headless.Listbox {...props} multiple={false}>
      ...
      >
        <Headless.ListboxSelectedOption
          ...
          className={cn([
            ...
            // Typography
            'text-left text-base/6 text-zinc-950 placeholder:text-zinc-500 dark:text-white dark:placeholder:text-zinc-400 sm:text-sm/6 forced-colors:text-[CanvasText]',
            // Border
            ...
            // Disabled state
            'group-data-disabled:border-zinc-950/20 group-data-disabled:opacity-100 dark:group-data-disabled:border-white/15',
          ])}
        />
        <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
          <svg
            className="size-5 stroke-zinc-500 group-data-disabled:stroke-zinc-600 dark:stroke-zinc-400 dark:group-data-disabled:stroke-zinc-500 sm:size-4 forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
      ...
      <Headless.ListboxOptions
        ...
        className={cn(
          ...
          // Popover background
          'bg-white/75 backdrop-blur-xl dark:bg-zinc-800/90',
          // Shadows
        ...
        return (
          <div
            className={cn(
              ...
              // Typography
              'text-base/6 text-zinc-950 dark:text-zinc-100 sm:text-sm/6 forced-colors:text-[CanvasText]',
              // Focus
...
export function ListboxDescription({ className, children, ...props }: React.ComponentPropsWithoutRef<'span'>) {
  return (
    <span
      ...
      className={cn(
        className,
        'flex flex-1 overflow-hidden text-zinc-500 group-data-focus/option:text-white dark:text-zinc-400 before:w-2 before:min-w-0 before:shrink'
      )}
    >
