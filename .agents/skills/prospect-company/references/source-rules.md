...
- Use the `find-person-email` skill rules while prospecting: work emails only, company website first, exact public evidence only, no personal emails, no pattern-only guesses.
